...
This project implements Variational Autoencoders (VAE) and Conditional Variational Autoencoders (CVAE) to reconstruct and complete handwritten drawings from the QuickDraw dataset.
